...
def get_params():
   ...
   params["rn_id"]="lstm_mdn_bs0_seq50_reset250_clippin" #running id, model
   params["notes"]="lstm training with mdn, gradient,reset 250 clipping" #running id
   ...
   params['reset_state']= 100000000#-1=Never, n=every n batch
