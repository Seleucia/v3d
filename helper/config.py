...
def get_params():
   ...
   params["rn_id"]="gredient_clipp" #running id, model
   params["notes"]="lstm training with  with gredient clipping, no resetting" #running id
   ...
   params['reset_state']= 10000000000000#-1=Never, n=every n batch
