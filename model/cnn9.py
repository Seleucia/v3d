...
class cnn9(object):
    def __init__(self,rng,params,cost_function='mse',optimizer = RMSprop):
        ...
        p_1=0.25
        dl2=DropoutLayer(rng,input=p2.output,prob=p_1,is_train=is_train)

        #Layer3: conv2+pool
        filter_shape=(64,p2.output_shape[1],3,3)
        c3=ConvLayer(rng, dl2.output,filter_shape,p2.output_shape,border_mode,subsample, activation=nn.relu)
        ...
        h2=HiddenLayer(rng,h1.output,1024,1024,activation=do_nothing)
