...
s_list=[2, 3, 4, 7, 8, 9, 13, 14, 15, 16, 18, 19, 20, 26, 27, 28]
s_list=[a-1 for a in s_list]
root=0
lst_act=['S9','S11','S1','S5','S6','S7','S8']

base_file="/mnt/Data1/hc/joints_mono/"
        ...
        for sq in lst_sq:
            ...
            for fl in file_list:
                ...
                with open(p, "rb") as f:
                  ...
                  rv=tmp_y[root]
                  f_y_diff=f_y-rv
                  f_y_diff=f_y_diff.flatten().T
                  numpy.savetxt(p.replace('joints_mono','joints16'),f_y_diff,fmt='%.4f',newline=' ')
